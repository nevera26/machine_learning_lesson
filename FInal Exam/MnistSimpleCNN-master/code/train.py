...
def run(p_seed=0, p_epochs=150, p_kernel_size=5, p_logdir="temp"):
    ...
    # file names ------------------------------------------------------------------#
    if not os.path.exists("../logs/%s"%p_logdir): #mengganti lokasi data dengan menghilangkan titik dan garis miring pertama
        os.makedirs("../logs/%s"%p_logdir)  #mengganti lokasi data dengan menghilangkan titik dan garis miring pertama
    OUTPUT_FILE = str("../logs/%s/log%03d.out"%(p_logdir,SEED))  #mengganti lokasi data dengan menghilangkan titik dan garis miring pertama
    MODEL_FILE = str("../logs/%s/model%03d.pth"%(p_logdir,SEED))  #mengganti lokasi data dengan menghilangkan titik dan garis miring pertama
